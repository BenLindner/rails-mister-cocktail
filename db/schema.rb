...
ActiveRecord::Schema.define(version: 2019_02_21_011615) do
  ...
  create_table "reviews", force: :cascade do |t|
    ...
    t.index ["ingredients_id"], name: "index_reviews_on_ingredients_id"
  end

  add_foreign_key "doses", "cocktails"
  add_foreign_key "doses", "ingredients", column: "ingredients_id"
  add_foreign_key "reviews", "cocktails"
  add_foreign_key "reviews", "ingredients", column: "ingredients_id"
end
